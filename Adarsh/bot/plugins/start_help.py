...
@StreamBot.on_message((filters.command("start") | filters.regex('𝕊𝕋𝔸ℝ𝕋⚡️')) & filters.private )
async def start(b, m):
...
@StreamBot.on_message((filters.command("help") | filters.regex('ℍ𝔼𝕃ℙ📚')) & filters.private )
